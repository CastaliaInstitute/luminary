...
val syncSceneAssets by tasks.registering(Copy::class) {
    ...
    // 2x screen-space assets, generated by scripts/build-ocean-screen-map.py
    // --scale 2 and the asset-prep step in that script's docstring.
    from(rootDir.resolve("scene-assets"))
